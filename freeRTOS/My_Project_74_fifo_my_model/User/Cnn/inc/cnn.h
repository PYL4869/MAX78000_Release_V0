...
/*
 * This header file was automatically @generated for the my_ssd_test_28_2 network from a template.
...
/*
  SUMMARY OF OPS
  Hardware: 198,603,232 ops (197,603,712 macc; 999,520 comp; 0 add; 0 mul; 0 bitwise)
    ...
    Layer 13: 9,216 ops (9,216 macc; 0 comp; 0 add; 0 mul; 0 bitwise)
    Layer 14: 4,478,976 ops (4,478,976 macc; 0 comp; 0 add; 0 mul; 0 bitwise)
    Layer 15: 27,648 ops (27,648 macc; 0 comp; 0 add; 0 mul; 0 bitwise)

  RESOURCE USAGE
  Weight memory: 302,688 bytes out of 442,368 bytes total (68.4%)
